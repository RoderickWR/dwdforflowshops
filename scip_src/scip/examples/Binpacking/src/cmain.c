   ...
   )
{
  ...
  /* include binpacking pricer  */
   ...
   // read problem file manually
   SCIP_RETCODE retcode;
   retcode = SCIPreadProb(scip, "u20_00.bpa", NULL);
   
   // run solve manually => to debug callbacks in pricer, conshandler, ...
   SCIPsolve(scip);

   /**********************************
    * Process command line arguments *
    **********************************/
   //not needed anymore because we manually load and solve
